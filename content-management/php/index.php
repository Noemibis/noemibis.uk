...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Introduction | The Shape of Design</title>
		<link href="style/style.css" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css?family=Lato:400,400i|Playfair+Display" rel="stylesheet"> 
	</head>
	<body>
        <? include($_SERVER['DOCUMENT_ROOT'].'/content-management/php/includes/header.inc.php');?>
		<main>
			<h1>The Shape of Design</h1>

			<p class="author">by Frank Chimero</p>
        ...
        <? include($_SERVER['DOCUMENT_ROOT'].'/content-management/php/includes/footer.inc.php');?>
	</body>
</html>
